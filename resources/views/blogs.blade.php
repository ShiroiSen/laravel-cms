    ...
    <div>
        ...
        <form action='/blogs' class="max-w-md mx-auto">   
            <div class="relative">
                ...
                <input type="input" name="searchblog" class="block w-full p-4 ps-10 text-md text-gray-900 border border-gray-300 rounded-lg bg-gray-50 bg-opacity-75" placeholder="Type Blog's Title" value="{{ request('searchblog') }}"/>
